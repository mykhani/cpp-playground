...
int main() {
	...
	cout << "Rope len 5, sizes(2,5,1) : max slices: "
			<< cut_rope(5, { 2, 5, 1 }) << endl;
	cout << "Rope len 23, sizes(12,9,11) : max slices: " << cut_rope(23, { 12,
			9, 11 }) << endl;
	cout << "Rope len 5, sizes(4,2,6) : max slices: "
			<< cut_rope(5, { 4, 2, 6 }) << endl;
	cout << "Rope len 9, sizes(2,2,2) : max slices: "
			<< cut_rope(9, { 2, 2, 2 }) << endl;
...

	{
		...
		cout << "Number of distinct elements in " << vec1 << " is " << countDistinctElements(vec1) << endl;
...

	{
		...
		std::cout << "Intersection of " << vec1 << " and " << vec2
				<< " is " << intersectionUnsorted(vec1, vec2) << endl;
...

	{
		...
		std::cout << "Longest common subarray with equal sum for" << endl
		          << vec1 << endl
				  << vec2 << endl
				  << " is " << longestCommonSubarrayWithGivenSum(vec1, vec2) << endl;
	}

	{
		std::vector<int> vec1 { 1, 9, 3, 4, 2, 20};
		std::cout << "Longest subsequence in " << vec1
				<< " is " << longsetSubsequence(vec1) << endl;
	}
